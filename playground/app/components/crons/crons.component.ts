...
export class CronsComponent {
  ...
  public loadCrons = () => {
    return of([
      { 'processId': 123123123, 'host': 'asdas wer5234523423213412421.23434234.com','state':'idle','cronSetting':{ 'summary':'Every minute','weekdays':[],'days':[],'hours':[],'minutes':[],'timeout':1,'disabled':false },'name':'Message Queue','id':1,'createDate':'2019-11-30T17:27:01+00:00','message':'','process':'process_message_queue','is_valid':null,'duration':100,'configs':null,'process_id':null,'long_running':'0' },
      { 'state':'failed','cronSetting':{ 'summary':'Every 5 minutes','weekdays':[],'days':[],'hours':[],'minutes':[0,5,10,15,20,25,30,35,40,45,50,55],'timeout':1,'disabled':false },'name':'Processes','id':2,'createDate':'2019-11-30T17:27:02+00:00','message':'','process':'process_processes','is_valid':null,'duration':5,'configs':null,'process_id':null,'long_running':'0' },
      { 'state':'running','cronSetting':{ 'summary':'Every day at 10:00 am America\/Toronto','weekdays':[],'days':[],'hours':[5],'minutes':[0],'timeout':1,'disabled':false },'name':'Temp Cleanup','id':3,'createDate': addSeconds(new Date(), 425),'message':'','process':'process_temp_cleanup','is_valid':null,'duration':0,'configs':null,'process_id':null,'long_running':'0' },
      { 'state':'disabled','cronSetting':{ 'summary':'Every minute','weekdays':[],'days':[],'hours':[],'minutes':[],'timeout':1,'disabled':true },'name':'Digest Emails','id':4,'createDate':'2019-05-10T15:33:15+00:00','message':'','process':'process_digest_emails','is_valid':null,'duration':500,'configs':null,'process_id':null,'long_running':'0' },
      { 'state':'queued','cronSetting':{ 'summary':'Every 30 minute','weekdays':[],'days':[],'hours':[],'minutes':[30],'timeout':1,'disabled':false },'name':'Digest Emails','id':4,'createDate':'2019-05-10T15:33:15+00:00','message':'','process':'process_digest_emails','is_valid':null,'duration':1555,'configs':null,'process_id':null,'long_running':'0' },
      { 'state':'killing','cronSetting':{ 'summary':'The 1st of each month at 7:00 am America\/Toronto','weekdays':[],'days':[1],'hours':[2],'minutes':[0],'timeout':1,'disabled':false },'name':'Timezones','id':5,'createDate':'2019-11-01T02:00:05+00:00','message':'','process':'process_timezones','is_valid':null,'duration':45,'configs':null,'process_id':null,'long_running':'0' },
    ]);
  };
